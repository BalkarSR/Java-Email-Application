...
The thisfile.txt includes the key information such as server, user, password, etc. It can be changed to whatever you want. However, for testing purposes I made up a gmail account to test. This one does not take any attachment files.
